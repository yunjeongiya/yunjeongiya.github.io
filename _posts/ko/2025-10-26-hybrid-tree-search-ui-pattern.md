...
![검색 기능 추가 전](../assets/images/posts/2025-10-26-hybrid-tree-search/before.png)
...
그래서 생각한 게 "검색 결과 리스트 + 전체 트리"를 동시에 보여주는 방식이다.
...
![하이브리드 패턴 적용 후](../assets/images/posts/2025-10-26-hybrid-tree-search/after.png)
