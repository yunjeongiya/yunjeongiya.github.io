...
[첫 번째 글](/posts/037/)에서 VS Code tasks.json으로 터미널 9개를 자동 실행하는 셋업을 만들었다. [두 번째 글](/posts/038/)에서 Claude Code가 VS Code 창을 3개씩 여는 버그를 겪었다. 세 번째 글에서 Ctrl+C로 터미널이 죽는 문제를 해결했다.
...
| Claude Code 실행 | [창 3개 버그](/posts/038/) | 문제 없음 |
| 메모리 사용 | ~1GB+ | ~100MB |
...
1. [바이브코딩은 셋업부터 — VS Code 자동화 가이드](/posts/037/) — tasks.json으로 터미널 9개 자동화
2. [Claude Code 실행하면 VSCode 창이 3개 열리는 버그 해결법](/posts/038/) — VS Code 내장 터미널 버그
3. VS Code 태스크 터미널, Ctrl+C 해도 안 죽게 만들기 — Windows 콘솔의 Ctrl+C 전파 문제
