...
> "이거 Discord 출석 시스템 마이그레이션하다가 중간에 멈춘 거 같은데, F052 문서화 해뒀을 거야. 찾아봐"

Claude가 F052 문서를 찾아서 열어봤다:
...
AI는 기억을 못 한다. 컨텍스트가 날아가면 처음부터 다시 설명해야 한다. 그런데 문서가 있으면? **"F052 문서화 해뒀을 거니까 찾아봐"** 한 마디면 된다. 내가 정확히 뭘 했는지 기억 안 나도, 문서 번호만 대충 기억하면 AI가 알아서 찾아서 읽는다.
